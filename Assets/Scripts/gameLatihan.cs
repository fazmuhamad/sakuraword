...
public class gameLatihan : MonoBehaviour {
	...
	void Start () {
		...
		txtInfoLevel.text = "Benar X dari X kata";
	...
	public void selectLevel(int i)
	{
		...
		txtInfoLevel.text = "Benar "+jBenar.ToString()+" dari "+nomerSoal.ToString()+" kata";
	...
	public void mulai()
	{
		Application.LoadLevel ("A"+idLevel.ToString());
	}
