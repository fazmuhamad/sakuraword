...
public class pengenalanKatakana : MonoBehaviour {

	private int idLevel;
	
	public Text huruf;
	public Text Katakana;
	...
	public string[] katakanaKatakana; 		//buat nyimpen soal
	...
	void Start () {
		...
		Katakana.text = katakanaKatakana[idSoal];
